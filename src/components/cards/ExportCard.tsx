...
const ExportCard: React.FC<ExportProps> = ({ exportRef }) => {
    ...
    return (
        <button
            className="flex gap-2 px-1 py-2 rounded-2xl justify-center items-center font-semibold text-headingMd text-white bg-blue-700 hover:cursor-pointer w-[160px] hover:bg-blue-500 transition delay-50 duration-100 ease-in-out"
